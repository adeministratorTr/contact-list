...
import contactReducer, { INITIAL_STATE } from './contact'

describe('Contact reducer tests', () => {
  it('returns initial - empty state', () => {
    expect(contactReducer(undefined, {})).toEqual(INITIAL_STATE)
  })

  it('should return contact object grouped by surname with filtered properties', () => {
